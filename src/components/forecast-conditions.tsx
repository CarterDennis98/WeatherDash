        ...
        <div style={{ display: "flex", justifyContent: "flex-start", minWidth: "250px", alignItems: "center" }}>
            <div style={{ display: "flex", flexDirection: "row", alignItems: "center", height: "100%" }}>
                <div style={{ height: "100%", display: "flex", alignItems: "center", position: "relative" }}>
                    <div style={{ height: "15px", width: "100%", position: "absolute", backgroundColor: "#808080ad", top: "10px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", height: "100%", marginLeft: "5px", justifyContent: "space-around" }}>
                    <div>
